...
class SpoonMealPlanScreen extends StatefulWidget {
  static const routeName = '/spoonRecipesScreen';

  @override
  _SpoonMealPlanScreenState createState() => _SpoonMealPlanScreenState();
}

class _SpoonMealPlanScreenState extends State<SpoonMealPlanScreen> {
  /*
  ...
  */
  ...
  void _searchMealPlan() async {
    SpoonMealPlan mealPlan = await ApiService.instance.generateMealPlan(
