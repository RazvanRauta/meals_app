...
import '../models/spoon_recipe.dart';
...
class ApiService {
  ...
  static const String API_KEY = "7688755d93aa40b0aa35067109327e07";
  ...
  Future<SpoonMealPlan> generateMealPlan(
      {int targetCalories, String diet}) async {
    ...
    */
    try {
      ...
      //MealPlan.fromMap
      SpoonMealPlan mealPlan = SpoonMealPlan.fromMap(data);
      return mealPlan;
    } catch (err) {
  ...
  Future<SpoonRecipe> fetchRecipe(String id) async {
    Map<String, String> parameters = {
    ...
    try {
      var response = await http.get(uri, headers: headers);
      Map<String, dynamic> data = json.decode(response.body);
      SpoonRecipe recipe = SpoonRecipe.fromMap(data);
      return recipe;
    } catch (err) {
      throw err.toString();
    }
